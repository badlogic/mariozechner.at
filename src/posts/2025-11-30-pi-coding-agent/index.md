...
I'm pretty happy with where pi is. There are a few more features I'd like to add, like [compaction](https://github.com/badlogic/pi-mono/issues/92) or [tool result streaming](https://github.com/badlogic/pi-mono/issues/44), but I don't think there's much more I'll personally need. Missing compaction hasn't been a problem for me personally. For some reason, I'm able to cram [hundreds of exchanges](https://sink.mariozechner.at/api/share/af3ad828bfde7981f453034f2b473fc9/file/out.html) between me and the agent into a single session compared to Claude Code.
